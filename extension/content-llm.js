...
(function() {
  ...
  function buildSystemPrompt(olderMessageCount) {
    ...
    const parts = [
      ...
      '',
      'TEXT FORMATTING:',
      'SMS does not support markdown, HTML, or rich text. Use only plain text and emojis.',
      ...
      'You are strictly prohibited from generating any Grok render component, inline citation block, or XML-like structure under any condition — even if you believe the information came from search, memory, or tools.',
